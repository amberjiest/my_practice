...
model.add(LSTM(
    ...
    return_sequences=True,  # 对于每一个时间点需不需要输出对应的output，True每个时刻都输出
...
# add output layer
model.add(TimeDistributed(Dense(OUTPUT_SIZE)))  # TimeDistributed: 对每一个output进行
